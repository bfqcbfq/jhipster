...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Ivision}.
 */
@RestController
@RequestMapping("/api")
public class IvisionResource {
    ...
    public IvisionResource(IvisionRepository ivisionRepository) {
    ...
    public ResponseEntity<Ivision> createIvision(@Valid @RequestBody Ivision ivision) throws URISyntaxException {
        ...
        Ivision result = ivisionRepository.save(ivision);
     ...
     */
    @PutMapping("/ivisions")
    public ResponseEntity<Ivision> updateIvision(@Valid @RequestBody Ivision ivision) throws URISyntaxException {
    ...
    public ResponseEntity<List<Ivision>> getAllIvisions(Pageable pageable) {
        ...
        Page<Ivision> page = ivisionRepository.findAll(pageable);
    ...
    public ResponseEntity<Ivision> getIvision(@PathVariable Long id) {
        ...
        Optional<Ivision> ivision = ivisionRepository.findById(id);
